    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-title-w-btn">
          <p><a href="<?= base_url(); ?>admin/brosur/add" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Tambah Data</a></p>
        </div>
        <div class="tile-body">
          <div class="table-responsive">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <?php $no=1; foreach($data as $row){?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><img src="<?= base_url()?>/public/image/upload/galeri_foto/<?= $row->file_brosur ?>" style="width: 100px; height: 100px;"></td>
                  <td><?= $row->keterangan_brosur ?></td>
                  <td>
                      <a href="<?= base_url(); ?>admin/brosur/edit/<?= $row->id_brosur ?>" type="submit" class="btn btn-sm btn-warning" id="<?= $row->id_brosur ?>"><i class="fa fa-lg fa-edit"></i></a>

                      <a type="submit" class="btn btn-sm btn-danger btnhapus" id="<?= $row->id_brosur ?>"><i class="fa fa-lg fa-trash"></i></a>
