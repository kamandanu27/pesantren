    ...
    <div class="row user">
      <div class="col-md-12">
        <div class="tile">
          ...
          <form action="<?php echo base_url().'admin/brosur/update'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                <label class="control-label col-md-3">Keterangan</label>
                <div class="col-md-6">
                  <input class="form-control" type="text" id="keterangan_brosur" name="keterangan_brosur" value="<?= $data['keterangan_brosur'] ?>" required>
                  <input class="form-control" type="hidden" id="id_brosur" name="id_brosur" value="<?= $data['id_brosur'] ?>" required>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <img src="<?= base_url()?>/public/image/upload/galeri_foto/<?= $data['file_brosur'] ?>" style="width: 100px; height: 100px;"><br>
