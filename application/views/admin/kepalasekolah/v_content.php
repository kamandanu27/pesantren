          ...
          <form action="<?php echo base_url().'admin/kepalasekolah/update'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                <label class="control-label col-md-3">Pimpinan Lembaga</label>
                <div class="col-md-5">
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                  <textarea class="form-control" rows="10" id="tujuan" name="tujuan" value=""><?= $data['tujuan'] ?></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Foto Pimpinan</label>
                  <div class="col-md-6">
                  <img src="<?= base_url() ?>public/image/upload/kepsek/<?= $data['poto'] ?>" style="width: 80px; height: 100px;">
                  <br>
