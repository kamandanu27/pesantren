    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-title-w-btn">
          <p><a href="<?= base_url(); ?>admin/slider/add" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Tambah Data</a></p>
        </div>
        <div class="tile-body">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              <thead>
                <tr>
                  ...
                  <th style="width: 55%;">Tulisan Besar</th>
                  <th style="width: 55%;">Tulisan Kecil</th>
              ...
              <?php $no=1; foreach($data as $row){?>
                <tr>
                  <td><?= $no++ ?></td>
                  <td><img src="<?= base_url()?>/public/image/upload/galeri_foto/<?= $row->file_slider ?>" style="width: 100px; height: 100px;"></td>
                  <td><?= $row->tulisanbesar_slider ?></td>
                  <td><?= $row->tulisankecil_slider ?></td>
                  <td>
                      <a href="<?= base_url(); ?>admin/slider/edit/<?= $row->id_slider ?>" type="submit" class="btn btn-sm btn-warning" id="<?= $row->id_slider ?>"><i class="fa fa-lg fa-edit"></i></a>

                      <a type="submit" class="btn btn-sm btn-danger btnhapus" id="<?= $row->id_slider ?>"><i class="fa fa-lg fa-trash"></i></a>
