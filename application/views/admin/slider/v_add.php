          ...
          <form action="<?php echo base_url().'admin/slider/insert'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="text" id="tulisanbesar_slider" name="tulisanbesar_slider" value="" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="text" id="tulisankecil_slider" name="tulisankecil_slider" value="" required>
                </div>
              </div>
