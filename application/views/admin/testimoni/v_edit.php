    ...
    <div class="row user">
      <div class="col-md-12">
        <div class="tile">
          ...
          <form action="<?php echo base_url().'admin/testimoni/update'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                <label class="control-label col-md-3">Nama</label>
                <div class="col-md-6">
                  <input class="form-control" type="text" id="nama_testimoni" name="nama_testimoni" value="<?= $data['nama_testimoni'] ?>" required>
                  <input class="form-control" type="hidden" id="id_testimoni" name="id_testimoni" value="<?= $data['id_testimoni'] ?>" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input class="form-control" type="text" id="keterangan_testimoni" name="keterangan_testimoni" value="<?= $data['keterangan_testimoni'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <textarea class="form-control" id="isi_testimoni" name="isi_testimoni"  rows="10"><?= $data['isi_testimoni'] ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <img src="<?= base_url()?>/public/image/upload/galeri_foto/<?= $data['file_testimoni'] ?>" style="width: 100px; height: 100px;"><br>
