    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-title-w-btn">
          <p><a href="<?= base_url(); ?>admin/kelas/add" class="btn btn-primary icon-btn"><i class="fa fa-plus"></i>Tambah Data</a></p>
        </div>
        <div class="tile-body">
              ...
              ?>
                <tr>
                  ...
                  <td>
                      ...
                      <a type="submit" class="btn btn-sm btn-danger btnhapus" id="<?= $row->id_kelas ?>"><i class="fa fa-trash"></i></a>
    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url() ?>admin/kelas/insert" method="post"> 
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="control-label">kelas Usaha</label>
            <input class="form-control" type="text" id="nama_kelas" name="nama_kelas" placeholder="" required>
          </div>
        </div>
