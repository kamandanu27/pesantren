    ...
    <div class="row user">
      <div class="col-md-12">
        <div class="tile">
          ...
          <form action="<?php echo base_url().'admin/juz/insert'?>" method="post" enctype="multipart/form-data">
            <div class="tile-body">
              <div class="form-group row">
                <label class="control-label col-md-3">Nama Juz</label>
                <div class="col-md-8">
                  <input class="form-control" type="text" id="nama_juz" name="nama_juz" value="" required>
