    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-sm-12 col-xs-12 wow fadeInUp">
                <div class="row">
                <?php $no=1; foreach($data_berita as $row_berita){?>
                    <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s" style="margin-top: 20px;">
                        <div class="blog-wrap">
                            <div class="blog-img">
                                <img src="<?= base_url(); ?>public/image/upload/berita/<?= $row_berita->blog_gambar ?>" alt="" style="height: 225px;"/>
                            </div>
                            <div class="blog-content">
                                <h3><a class="judul" href="<?= base_url()?>berita/<?= $row_berita->blog_slug ?>"><?= character_limiter($row_berita->blog_judul,50) ?></a></h3>
                                <div class="blog-meta">
                                    <ul>
                                        <li><a><i class="fa fa-calendar"></i> <?= format_indo($row_berita->publish_date) ?></a></li>
                                    </ul>
                                    <ul>
                                        <li><a><i class="fa fa-user"></i> <?= $row_berita->name_user ?></a></li>
                                        <li><a><i class="fa fa-eye"></i> <?= $row_berita->blog_views ?></a></li>
                                    </ul>
                                    
                                </div>
                                <p><?= character_limiter($row_berita->blog_isi,200) ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px; text-align: center;">
                        ...
                        <button type="button" class="btn-style btnloadberita" style="border:1px solid #006616;">Lainya <i class="fa fa-angle-double-right"></i></button>
                        </div>
                    </div>
