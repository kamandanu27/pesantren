          ...
          <div class="widget widget-nopad">
            <div class="widget widget-table action-table">
              ...
              <div class="widget-content" >
                <form class="form-horizontal" style="margin:20px;" enctype="multipart/form-data" action="<?= base_url() ?>admin/instrument/update" method="post">
					<fieldset>
										
						<div class="control-group">					
							<label class="control-label">Id Instrument</label>
							<div class="controls">
								<input type="text" required class="span3 disabled" id="id_instrument" name="id_instrument" value="<?= $id ?>" readonly>
							</div>
						</div>
                    	...
                    	<div class="control-group">											
							...
							<div class="controls">
								<input type="text" required class="span6 disabled" id="name_instrument" name="name_instrument" value="<?= $data->name_instrument ?>">
							</div>			
						</div> 
						...
						<div class="control-group">											
							...
							<div class="controls">
								<input type="text" required class="span3" id="name_company" name="name_company"  value="<?= $data->name_company ?>" readonly>
								<button type="button" class="btn btn-primary btn_cari_company"><i class="btn-icon-only icon-search"> </i></button> 
								<input type="hidden" class="span3" id="id_company" name="id_company"  value="<?= $data->id_company ?>" required>
							</div>	
						</div>
                    	...
                    	<div class="control-group">											
							...
							<div class="controls">
                        	<textarea type="text" required rows="4"  class="span6 disabled" id="street_company" name="street_company" readonly><?= $data->street_company ?></textarea>
							</div>	
						</div>
